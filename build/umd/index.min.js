...
/**
	 ...
	 * @license MIT
	 */
const o={noScroll:function(){window.addEventListener("load",(function(){document.body.style.height="100%",document.body.style.overflow="hidden",document.documentElement.style.height="100%",document.documentElement.style.overflow="hidden"}),!1)}};
/**
	 * InputDetect
	 *
	 * @module InputDetect
	 * @author natade (https://github.com/natade-jp)
	 * @license MIT
	 */return{IDDraggableSwitch:s,IDMouse:i,IDPosition:e,IDSwitch:t,IDTouch:
/**
	 * IDTouch.js
	 *
	 * @module InputDetect
