 ...
 * @author natade (https://github.com/natade-jp)
 * @license MIT
 */class h{constructor(){this._data=new o}static create(){return new h}setListenerOnElement(t){this._data.setListenerOnElement(t)}pickInput(){const t=new o;return this._data.pickInput(t),t}static noScroll(){n()}}module.exports=h;
